...
namespace Vintagestory.GameContent
{
    public class GuiDialogBlockEntityWitchOven : GuiDialogBlockEntity
    {
        ...
        public GuiDialogBlockEntityWitchOven(string dlgTitle, InventoryBase Inventory, BlockPos bePos, SyncedTreeAttribute tree, ICoreClientAPI capi) : base(dlgTitle, Inventory, bePos, capi)
        {
